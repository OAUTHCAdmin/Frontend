...
import { loginRequest } from "@/logic/data/auth/login";
import { initialAPIState } from "@/logic/interface/login";
...
export default function SignInForm() {
  ...
  const [state, formAction] = useActionState(loginRequest, initialAPIState);
  ...
  const handleSubmit = (event?: React.FormEvent) => {
    ...
    startTransition(() => {
      ...
      formData.set("rememberMe", keepLoggedIn ? "true" : "false");
      formAction(formData);
      //   setLoading(true);
